...
function renderRequesterHome(){
  ...
  return h`
    <div class="hero requester-home-hero" style="color:#1452a3!important"><h2 style="color:#1452a3!important;opacity:1!important;text-shadow:none!important">Hola, ${safe(firstName())}</h2><p style="color:#466b98!important;opacity:1!important">Desde aquí puedes radicar solicitudes, consultar tus casos y revisar el cronograma institucional de TIC y Comunicaciones.</p><div class="hero-actions"><button class="btn btn-secondary premium-btn" style="color:#1452a3!important;background:#fff!important;border:1px solid #adccef!important;opacity:1!important" data-jump="new_request"><span class="btn-mini-icon">${assetIcon('ticket-service','Nueva solicitud','btn-mini-img')}</span>Nueva solicitud</button><button class="btn btn-secondary premium-btn" style="color:#1452a3!important;background:#fff!important;border:1px solid #adccef!important;opacity:1!important" data-jump="my_requests"><span class="btn-mini-icon">${assetIcon('role-funcionario','Mis solicitudes','btn-mini-img')}</span>Ver mis solicitudes</button><button class="btn btn-secondary" style="color:#1452a3!important;background:#fff!important;border:1px solid #adccef!important;opacity:1!important" data-jump="schedule"><span class="btn-mini-icon">${assetIcon('calendar-planner','Cronograma','btn-mini-img')}</span>Cronograma</button></div></div>
